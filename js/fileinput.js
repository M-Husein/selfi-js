...
(function(factory){
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="gi gi-trash text-danger"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="gi gi-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        zoomIcon: '<i class="gi gi-zoom-in"></i>',
        zoomClass: 'btn btn-xs btn-default',
        zoomTitle: 'View Details',
        dragIcon: '<i class="gi gi-menu-hamburger"></i>',
        dragClass: 'text-info',
        dragTitle: 'Move / Rearrange',
        dragSettings: {},
        indicatorNew: '<i class="gi gi-hand-down text-warning"></i>',
        indicatorSuccess: '<i class="gi gi-ok-sign text-success"></i>',
        indicatorError: '<i class="gi gi-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i class="gi gi-hand-up text-muted"></i>',
    ...
    tPreview = '<div class="file-preview {class}">\n' +
        ...
        '    </div>\n' +
        '</div>';
    tClose = '<div class="close fileinput-remove" title="Cancel">&times;</div>\n';
    tFileIcon = '<i class="gi gi-file kv-caption-icon"></i>';
            ...
            handler($btnTogh, 'click', function () {
                ...
                if ($header.is(':visible')) {
                    ...
                    $header.slideUp('slow', function () {
                        $actions.find('.btnBS').appendTo($floatBar);
                        resize(ht);
                    });
                } else {
                    $floatBar.find('.btnBS').appendTo($actions);
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="gi gi-triangle-left"></i>',
            next: '<i class="gi gi-triangle-right"></i>',
            toggleheader: '<i class="gi gi-resize-vertical"></i>',
            fullscreen: '<i class="gi gi-fullscreen"></i>',
            borderless: '<i class="gi gi-resize-full"></i>',
            close: '<i class="gi gi-remove"></i>'
        },
        previewZoomButtonClasses: {
            prev: 'btn bs btn-navigate',
            next: 'btn bs btn-navigate',
            toggleheader: 'btn bs btn-default btn-header-toggle',
            fullscreen: 'btn bs btn-default',
            borderless: 'btn bs btn-default',
            close: 'btn bs btn-default'
        },
        ...
        previewFileIcon: '<i class="gi gi-file"></i>',
        previewFileIconClass: 'file-other-icon',
        previewFileIconSettings: {},
        previewFileExtSettings: {},
        buttonLabelClass: 'hidden-xs',
        browseIcon: '<i class="gi gi-folder-open"></i>&nbsp;',
        browseClass: 'btn bs btn-primary',
        removeIcon: '<i class="gi gi-trash"></i>',
        removeClass: 'btn bs btn-default',
        cancelIcon: '<i class="gi gi-ban-circle"></i>',
        cancelClass: 'btn bs btn-default',
        uploadIcon: '<i class="gi gi-upload"></i>',
        uploadClass: 'btn bs btn-default',
        uploadUrl: null,
        uploadAsync: true,
        uploadExtraData: {},
        zoomModalHeight: 480,
        ...
        msgValidationErrorIcon: '<i class="gi gi-exclamation-sign"></i> ',
