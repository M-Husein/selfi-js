		...
		return this.each(function(){
			...
			f = function(j,n){
				...
				if(n == "destroy"){
					...
					v = e(v);
					if(n.calendar != "false"){
						z = ((w == "en") ? "<div class='clockdate'>"+c[w].weekdays[u]+", "+c[w].months[k]+" "+i+", "+q+"</div>" : "<div class='clockdate'>"+c[w].weekdays[u]+", "+i+" "+c[w].months[k]+" "+q+"</div>");
					}
					$(j).html(z+"<div class='clocktime'>"+p+":"+l+":"+v+o+"</div>");
...
$(document).ready(function(){
	...
	$("#destroyclock1").click(function(){
		$("#clock1").clock("destroy");
	});
	$("#destroyclock2").click(function(){
		$("#clock2").clock("destroy");
	});
	$("#destroyclock3").click(function(){
		$("#clock3").clock("destroy");
	});
	$("#destroyclock4").click(function(){
		$("#clock4").clock("destroy");
	});
	$("#destroyclock5").click(function(){
